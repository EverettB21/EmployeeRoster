//
//  EmployeeTypeTableTableViewController.swift
//  EmployeeRoster
//
...
protocol EmployeeTypeTableDelagate {
    func employeeTypeTableViewController(_:EmployeeTypeTableTableViewController,didSelect:EmployeeType)
}

class EmployeeTypeTableTableViewController: UITableViewController {

    var employeeType: EmployeeType?
    var delegate: EmployeeTypeTableDelagate?
